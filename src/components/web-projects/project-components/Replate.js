...
const Replate = () => {
    ...
    const [projectData] = useState(data[2]);

    // THESE MANAGE THE CAROUSEL STATE
    const [galleryImages] = useState(data[2].galleryImages);
            ...
            <div className="project-intro">
                <Jumbotron className="project-title">
                    ...
                    <div className="project-info">
                        ...
                        <a href={projectData.repositoryLink} target="_blank" rel="noopener noreferrer"><Button block>Github Repo</Button></a>
