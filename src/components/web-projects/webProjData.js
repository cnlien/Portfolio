export default [

    {
        ...
        img: './img/web-projects/french-lick-winery.jpg',
        url: 'http://www.frenchlickwinery.com',
        description: 'This website was build using the Squarespace Platform. The goal for this website was to replace their existing and outdated website and allow for the client to maintain themselves. They were also looking to be able to integrate their existing wine shopping cart system in to their new site. Squarespace was chosen for the endless customization that is available and the ease of the WYSIWYG editor for individuals who do not know how to code. The shopping cart system, Vino Shipper, is integrated using Javascript.',
        projectlink:'/frenchlickwinery',
        repositoryLink: 'https://github.com/cnlien/French-Lick-Winery',
        buttonText: 'Github Repo',
        galleryTitle: 'Screenshots',
        galleryImages:
            [
                {
                    src: './img/web-projects/frenchlickwinery/image-1.png',
                    altText: 'French Lick Winery Screenshot',
                },

                {
                    src: './img/web-projects/frenchlickwinery/image-2.png',
                    altText: 'French Lick Winery Screenshot',
                },
                
                {
                    src: './img/web-projects/frenchlickwinery/image-3.png',
                    altText: 'French Lick Winery Screenshot',
                },

                {
                    src: './img/web-projects/frenchlickwinery/image-4.png',
                    altText: 'French Lick Winery Screenshot',
                },

                {
                    src: './img/web-projects/frenchlickwinery/image-5.png',
                    altText: 'French Lick Winery Screenshot',
                },
            ],
        technologyLogos:
    ...
    {
        id: 2,
        project: 'Spirits of French Lick',
        stack: 'HTML/CSS, JavaScript, SquareSpace',
        img: './img/web-projects/spirits-of-french-lick.jpg',
        ...
        repositoryLink: 'https://www.spiritsoffrenchlick.com',
        buttonText: 'View the Site',
        galleryTitle: 'Screenshots',
        galleryImages:
            [
              {
                src: './img/web-projects/spiritsoffrenchlick/image-1.png',
                altText: 'Spirits of French Lick Mock Ups',
              },

              {
                src: './img/web-projects/spiritsoffrenchlick/image-2.png',
                altText: 'Spirits of French Lick Mock Ups',
              },

              {
                src: './img/web-projects/spiritsoffrenchlick/image-3.png',
                altText: 'Spirits of French Lick Mock Ups',
              },

              {
                src: './img/web-projects/spiritsoffrenchlick/image-4.png',
                altText: 'Spirits of French Lick Mock Ups',
              },
              
              {
                src: './img/web-projects/spiritsoffrenchlick/image-5.png',
                altText: 'Spirits of French Lick Mock Ups',
              },
...

    {
        ...
        img: './img/web-projects/replate.jpg',
        url: 'https://build-weeks-replate.github.io/UI/',
        description: 'Replate was the first Build Week project I completed during my time at Lambda School. My role on the team was to create a marketing and landing page using HTML, CSS and Less. I also was in charge of the UI/UX design, graphic design and color pallete. The goal of the project was to build an iOS app where restauraunts could submit food at the end of the night to be picked up by local homeless shelters rather than be pitched.',
        projectlink:'/replate',
        repositoryLink: 'https://github.com/build-weeks-replate',
        buttonText: 'Github Repo',
        galleryTitle: '',
        galleryImages:
            [
...

    {
        ...
        repositoryLink: 'https://github.com/cnlien/nasa-photo',
        buttonText: 'Github Repo',
        galleryTitle: 'Screenshots',
        galleryImages:
            [
...

    {
        ...
        repositoryLink: 'https://github.com/Potluck-Planner-Lambda',
        buttonText: 'Github Repo',
        galleryTitle: 'Screenshots',
        galleryImages:
            [
...

    {
        ...
        repositoryLink: 'https://github.com/bw-pt-fishfriends2',
        buttonText: 'Github Repo',
        galleryTitle: 'Screenshots',
        galleryImages:
            [
...

    {
        ...
        repositoryLink: 'https://github.com/cnlien/dark-mode',
        buttonText: 'Github Repo',
        galleryTitle: 'Screenshots',
        galleryImages:
            [
...

    {
        ...
        repositoryLink: 'https://github.com/cnlien/React-Todo',
        buttonText: 'Github Repo',
        galleryTitle: 'Screenshots',
        galleryImages:
            [
